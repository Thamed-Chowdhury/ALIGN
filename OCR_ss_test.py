...
ocr_reader = easyocr.Reader(['bn', 'en'], gpu=True)
...
#     places = ["ফেনী", "পল্লী", "বিদ্যুৎ", "সমিতি"]
#     image_path = "screenshot_feni.png"

#     found, extracted_texts = chunkwise_OCR_agent(
#         places=places,
...
#     print("\n✅ Final Match Result:", found)
#     print("📝 Total OCR lines extracted:", len(extracted_texts))
